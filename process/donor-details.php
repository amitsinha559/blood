...
<?php
	...
	if(isset($_POST['get']) && isset($_POST['area']) && isset($_POST['blood_group']) && isset($_POST['country_code']) && $_POST['get'] == "list") {
